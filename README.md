<!-- ===== HEADER BANNER ===== -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=220&section=header&text=Min%20Yujin&fontSize=64&fontAlignY=38&fontColor=ffffff&desc=Backend%20Engineer%20%C2%B7%20Industrial%20Safety%20IoT%20Platform&descSize=18&descAlignY=60&animation=twinkling" alt="header" />
</p>

<!-- ===== TYPING ANIMATION ===== -->
<p align="center">
  <a href="https://github.com/gnxm37">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3000&pause=800&color=4FC08D&center=true&vCenter=true&width=620&lines=Backend+Engineer+%40+IDB+Lab+%F0%9F%9A%80;NestJS+%C2%B7+TypeScript+%C2%B7+TypeORM;Multi-tenant+SaaS+%C2%B7+Realtime+pipelines;Industrial+IoT+%C2%B7+Edge+devices+%C2%B7+MQTT" alt="typing" />
  </a>
</p>

<!-- ===== BADGES ROW ===== -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=gnxm37&label=Profile+views&color=4fc08d&style=flat-square" alt="views" />
  <img src="https://img.shields.io/github/followers/gnxm37?label=Followers&style=flat-square&color=4fc08d" alt="followers" />
  <img src="https://img.shields.io/github/stars/gnxm37?label=Stars&style=flat-square&color=4fc08d" alt="stars" />
</p>
...
- 🏭 **산업 안전 IoT 플랫폼** 백엔드를 다룹니다. 단일 테넌트로 출발한 NestJS 모놀리스를 **외부 고객사 단위 SaaS**로 전환 중
- 🔐 HTTP / WebSocket / gRPC / MQTT **모든 진입점에 `TenantContext` 일관 적용**, 5개 게이트웨이 tenant-prefixed room 격리
- 📡 대시보드 실시간 파이프라인 정합성·성능 개선 — "카운트 -1 회귀" / "위젯 emit 중복" 종결
- 🌳 **DBMS 메타 트리 통합 API** — `with-status` 2종 → `tree` 단일 엔드포인트, FE 분기를 BE 정책 한 곳으로 일원화
- 📈 **운영 가시성** — Prometheus + Grafana + Alertmanager + cAdvisor + jetson_stats_exporter 로 엣지 디바이스 헬스 모니터링 PoC
...
<table align="center">
  ...
  <tr>
    <td align="center"><b>Collab · Tools</b></td>
    <td>
...
<p align="center">
  <a href="https://www.gitanimals.org/en_US?utm_medium=image&utm_source=gnxm37&utm_content=line" target="_blank" rel="noopener noreferrer">
    <img src="https://render.gitanimals.org/lines/gnxm37?pet-id=703527561344648045" width="600" height="120" alt="My GitAnimals pet" />
  </a>
</p>
