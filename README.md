...
| 원칙 | 설명 |
|---|---|
| **작은 값도 검증** | 화면 숫자가 미세하게 어긋나는 것도 원인을 찾아 맞춥니다. |
| **점진적으로 바꾸기** | 쓰던 걸 갑자기 끊지 않고, 새 방식과 같이 돌려본 뒤 문제없을 때 정리합니다. |
| **피드백을 새 시도로** | 사내 다른 팀이 제가 만든 문서 기능을 쓰며 불편해하던 점을 듣고, 문서 뷰어 개선을 직접 기획해 프로토타입·PR로 진행했습니다. |
